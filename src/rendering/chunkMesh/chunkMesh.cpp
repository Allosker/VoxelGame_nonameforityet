			...
			{	
				...
				if (type.is_transparent)
				{
					mp.second.emplace_back( std::pair<vec3f, std::array<VoxelVertex, 6>>
					{
						...
						VoxelVertex{ Data::Voxel::faces[index + 0] + translation + offset[i], type.uvs[i][0], 1.f, light_corners[0] },  
						VoxelVertex{ Data::Voxel::faces[index + 1] + translation + offset[i], type.uvs[i][1], 1.f, light_corners[1] },
						VoxelVertex{ Data::Voxel::faces[index + 2] + translation + offset[i], type.uvs[i][2], 1.f, light_corners[2] },
						VoxelVertex{ Data::Voxel::faces[index + 3] + translation + offset[i], type.uvs[i][1], 1.f, light_corners[1] },
						VoxelVertex{ Data::Voxel::faces[index + 4] + translation + offset[i], type.uvs[i][3], 1.f, light_corners[3] },
						VoxelVertex{ Data::Voxel::faces[index + 5] + translation + offset[i], type.uvs[i][2], 1.f, light_corners[2] }
						}
					});
				}
				else
				{
					...
					static constexpr std::array<float, 4> s_values{ 0.7f, 0.8f, 0.9f, 1.f };
					...
					mp.first.push_back({ Data::Voxel::faces[index + 0] + translation + offset[i], type.uvs[i][0], corners[0], /*light_corners[0]*/ });
					mp.first.push_back({ Data::Voxel::faces[index + 1] + translation + offset[i], type.uvs[i][1], corners[1], /*light_corners[1]*/ });
					mp.first.push_back({ Data::Voxel::faces[index + 2] + translation + offset[i], type.uvs[i][2], corners[2], /*light_corners[2]*/ });
					mp.first.push_back({ Data::Voxel::faces[index + 3] + translation + offset[i], type.uvs[i][1], corners[1], /*light_corners[1]*/ });
					mp.first.push_back({ Data::Voxel::faces[index + 4] + translation + offset[i], type.uvs[i][3], corners[3], /*light_corners[3]*/ });
					mp.first.push_back({ Data::Voxel::faces[index + 5] + translation + offset[i], type.uvs[i][2], corners[2], /*light_corners[2]*/ });
				}
			}																					 					   
